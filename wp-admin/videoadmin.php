...
if(isset($_SESSION["userlogged"]) AND $_SESSION["userlogged"]!="" AND $_SESSION["userlogged"]!=" ")
{
	...
	echo "<a href='index.php?lng=".$webaktlang."&mod=y&ujvideo' class='btn'>+ új videó hozzáadása &raquo;</a><br><br>";
		...
		{
			echo $evid["videocim"]." | <a href='index.php?lng=".$webaktlang."&mod=y&videotorol=".$evid["videokod"]."' onclick='return confirm(\"Biztosan törlöd ezt a videót?\")'>[ TÖRLÉS ]</a> 
				<a href='index.php?lng=".$webaktlang."&mod=y&videomod=".$evid["videokod"]."'>[ MÓDOSÍTÁS ]</a><br>";
		}
		echo "</p>";
}
?>