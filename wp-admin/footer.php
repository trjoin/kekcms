		...
		<div class="row">
			<div class="span4">
				...
				<ul>
					...
					<li><a href="https://szerviz-szolnok.hu" target="_blank">Számítógép, Laptop szerviz &raquo;</a></li>
					<li><a href="https://gps-szolnok.hu/" target="_blank">GPS Szerviz, szoftverezés &raquo;</a></li>
				</ul>
			</div>
			<div class="span4">
				<h4>Hozzáférések</h4>
				<ul>
					<li><a href="<?php echo $absp; ?>" target="_blank">Weblapom megtekintése &raquo;</a></li>
					<li><a href="index.php">Admin felület főoldal &raquo;</a></li>
					<li><a href="index.php?mod=y&usermod=1">Belépési adatok megváltoztatása &raquo;</a></li>
				</ul>
			</div>
			<div class="span4">
