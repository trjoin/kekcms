...
/*** modulos táblák létrehozása és feltöltése ***/
	...
	//shop tábla
		...
		{
			$letrehoz_shop=$pdo->query("CREATE TABLE ".$elotag."_shop_termek (tid int(20) NOT NULL AUTO_INCREMENT, t_gyarto varchar(200) NOT NULL, t_nev text NOT NULL, t_cikkszam text NOT NULL, t_ar int(10) NOT NULL, t_akciosar int(10) NOT NULL, t_kategoria int(10) NOT NULL, t_alkategoria int(10) NOT NULL, t_fkep text NOT NULL, t_kepek text NOT NULL, t_kleiras varchar(200) NOT NULL, t_nleiras text NOT NULL, t_datum date, t_aktiv int(2) DEFAULT '1', t_kiemelt int(2) DEFAULT '0', t_pdf text NOT NULL, PRIMARY KEY (tid)) DEFAULT CHARSET=utf8");
